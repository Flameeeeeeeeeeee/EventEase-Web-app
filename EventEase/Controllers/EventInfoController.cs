...
namespace EventEase.Controllers
{
    public class EventInfoController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchType, int? VenueID, DateTime? EventDate)
        {
            ...
            if (EventDate.HasValue )
                eventInfo = eventInfo.Where(e => e.EventDate.Date == EventDate.Value.Date);
        ...
        [HttpPost]
        public async Task<IActionResult> Create(EventEase.Models.EventInfo eventInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, EventEase.Models.EventInfo eventInfo)
        {
